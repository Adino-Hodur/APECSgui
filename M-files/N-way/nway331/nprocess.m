function [Xnew,mX,sX]=nprocess(X,Cent,Scal,mX,sX,reverse2,show,usemse);
...
% $ Version 2.03 $ Aug 2017 $ Changed the name of reverse to reverse2 to avoid conflict with built in function $ RB $ Not compiled $
